...
def main():
    ...
    if len(sys.argv) < 2:
        print("使用方法:")
        print("  python data/data_restore.py <功能> [参数]")
        print("\n可用功能:")
        ...
        print("\n示例:")
        print("  python data/data_restore.py templates")
        print("  python data/data_restore.py db-full")
        print("  python data/data_restore.py db-list")
        print("  python data/data_restore.py zip data/backups/full_backup_xxx.zip")
        print("  python data/data_restore.py git c4818a4")
        sys.exit(1)
